...
class ResNet34_Conf_Localizer2(nn.Module):
    ...
    def __init__(self):
        ...
        member variables.
        """
        super(ResNet34_Conf_Localizer2, self).__init__()
        ...
        self.regressor2 = nn.Sequential(
                          nn.Linear(reg_out_num + 5, reg_out_num,bias=True))#,
                          #nn.ReLU())
    ...
    def forward(self, x,prev_x):
        ...
        return cls_out,reg_out #inter_in
